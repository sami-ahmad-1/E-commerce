...
//     const newFilter = await { ...filter, _sort: option.sort, _order: option.order }
//     setFilter(newFilter)
//     dispatch(fetchAllProductsbyFilter(newFilter))
...
//                                       // onChange={e => console.log('random',e)}
//                                       // onClick={e => console.log('Sami' , e)}
...
function Products() {
  ...
  const totalPage = totalProduct / 10       // 10
  // const handleFilter = (e, section, option) => {
  //     const newFilter = { ...filter, [section.id]: option.value }
  //     setFilter(newFilter)
  //     dispatch(fetchAllProductsbyFilter(newFilter))
